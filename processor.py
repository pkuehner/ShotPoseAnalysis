...
class FrameProcessor:
    ...
    def process_image(self, image):
        ...
        for angle in angles:
            ...
            self.frames.append(Frame(self.frame_counter, image, landmarks_list, angles))
    ...
    def post_process(self):
        ...
        cv2.putText(knees_released_frame.image, str("Knees Fully Extended"), (500, 500), cv2.FONT_HERSHEY_PLAIN, 2, (0,0,255), 2) 

        jump_frame = self.find_jump_frame(shot_start_frame)
        jump_frame.pause = True
        cv2.putText(jump_frame.image, str("JUMP Start"), (500, 500), cv2.FONT_HERSHEY_PLAIN, 2, (0,0,255), 2) 
